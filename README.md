...
Литературу, пример отчета и задание от преподавателя на паре см. в директории Latex. 
...
Также было рекомендовано ознакомиться со следующей литературой http://svnbook.red-bean.com/nightly/ru/index.html. Задание от преподавателя на паре см. в директории SVN.
